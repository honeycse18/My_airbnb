...
class QuestionsBottomSheetWidgetController extends GetxController {
...
class QuestionsBottomSheetWidget extends StatelessWidget {
  final String title;
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      init: QuestionsBottomSheetWidgetController(),
      builder: (QuestionsBottomSheetWidgetController controller) {
        return SizedBox(
